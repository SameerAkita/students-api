...
import (
	...
	"github.com/SameerAkita/students-api/internal/storage"
	"github.com/SameerAkita/students-api/internal/types"
	"github.com/SameerAkita/students-api/internal/utils/response"
...
func GetById(storage storage.Storage) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id") // this gets {id} in the api call
		slog.Info("getting a student", slog.String("id", id))

		intId, err := strconv.ParseInt(id, 10, 64)
		if err != nil {
			slog.Error("error converting id to int64", slog.String("id", id))
			response.WriteJson(w, http.StatusBadRequest, response.GeneralError(err))
			return
		}
...
func DeleteById(storage storage.Storage) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		response.WriteJson(w, http.StatusNoContent, "deleted id: " + id)
	}
}